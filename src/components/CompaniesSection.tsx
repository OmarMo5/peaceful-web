...
const CompaniesSection = () => {
  ...
  return (
    <section id="companies" ref={sectionRef} className="py-24 bg-secondary">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {companies.map((company, index) => (
            <div
              key={index}
              className={`group bg-card rounded-2xl p-6 shadow-sm card-hover border-t-4 border-t-transparent hover:border-t-primary transition-all duration-500 ${
            ...
            >
              ...
              {/* Link Button */}
              <button className="inline-flex items-center gap-2 text-primary font-semibold text-sm group-hover:text-accent transition-colors">
                زيارة الموقع
