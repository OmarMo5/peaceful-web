  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-brand overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        {/* Small Label */}
        <span className="animate-fade-up inline-block text-accent text-lg font-semibold mb-6 tracking-wide">
          مجموعة السلام
        </span>
        ...
        <p className="animate-fade-up-delay-2 text-lg md:text-xl text-primary-foreground/85 max-w-3xl mx-auto mb-12 leading-relaxed">
        ...
        <div className="animate-fade-up-delay-3">
          <button
            ...
            className="group inline-flex items-center gap-3 bg-primary-foreground text-primary px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 hover:bg-accent hover:text-accent-foreground hover:shadow-brand-lg hover:-translate-y-1"
          >
            اكتشف شركاتنا
