...
const stats = [
  ...
  { icon: Globe, value: "10M+", label: "زائر حول العالم" },
  { icon: Award, value: "١٨+", label: "عاماً من الخبرة" },
];
        ...
        <div className="grid lg:grid-cols-2 gap-10 md:gap-12 lg:gap-16 items-center">
          ...
          <div className={`transition-all duration-700 ease-out ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"}`}>
            ...
            <div className="space-y-5 sm:space-y-6 text-muted-foreground text-base sm:text-lg leading-relaxed">
              <p>
                مجموعة السلام القابضة (ASG) مجموعة قابضة سعودية مملوكة بالكامل لوقف الكتاب والحكمة، بدأت فكرتها من عام 2007م كمشروع علمي تأصيلي، ثم تطورت إلى منظومة مؤسسية تقود أربع شركات متخصصة في مجالات المعرفة، والثقافة، والتشغيل، والتنفيذ، والمنتجات.
              </p>
              <p>
                بما يصنع قيمة مستدامة وأثراً حضارياً ومؤسسياً ممتداً عبر الأجيال، تبدأ من البحث والمعرفة، وتمتد إلى التصميم والتنفيذ والتشغيل، وتنتهي بإنتاج المنتجات الحضارية والتجارب التي تصل إلى ملايين الزوار حول العالم.
              </p>
            </div>
